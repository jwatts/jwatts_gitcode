...
CREATE TABLE `HELP_R_RSC_SUBCAT` (
  ...
  `R_SUBCAT_ORDER` int(10) NOT NULL,
  `R_SUBCAT_ACTV_FLG` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (R_SUBCAT_ID)
);

CREATE TABLE `HELP_R_RSC_STS` (
  `R_STS_ID` int(10) NOT NULL AUTO_INCREMENT,
  `R_STS_CD` varchar(255) DEFAULT NULL,
  `R_STS_VAL` varchar(255) DEFAULT NULL,
  `R_STS_ORD` int(10) DEFAULT NULL,
  `R_STS_ACTV_FLG` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `HELP_RSC` (
  ...
  `R_CAT_ID` int(10) DEFAULT NULL,
  `R_SUBCAT_ID` int(10) UNSIGNED DEFAULT NULL,
  ...
  `RSC_CNTCT_NAME` varchar(255) NOT NULL,
  `RSC_CNTCT_PHONE` varchar(255) NOT NULL,
  `RSC_CNTCT_EMAIL` varchar(255) NOT NULL,
...
CREATE VIEW `HELP_V_RESOURCE`  AS  
  select 
    ...
    cast(`rsc`.`R_CAT_ID` as char(1) charset utf8mb4) AS `R_CAT_ID`,
